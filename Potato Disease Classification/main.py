...
Tomato_classes = ['Tomato_healthy', 'Tomato_Spider_mites_Two_spotted_spider_mite', 'Tomato__Target_Spot',
...
st.header("TARP PROJECT")
st.write("This application is detecting disease in three plants potato, tomato and pepper")
...
async def pepper():
    if uploaded_file is not None:
        ...
        st.write("Predicted Class : ", pepper_classes, "         Confidence Level : ", confidence)
